...
declare module "grommet/components/icons/Spinning" {
  export default class Spinning extends React.Component<any,any>{}
}

declare module "grommet/components/icons/base/Close" {
  export default class Close extends React.Component<any,any>{}
}
...
declare module Grommet {
  ...
  type FooterProps = BoxProps<Footer> & {
    fixed?: boolean;
    float?: boolean;
    primary?: boolean;
    size?: 'small' | 'medium' | 'large';
  ...
  type HeaderProps = BoxProps<Header> & {
    fixed?: boolean;
    float?: boolean;
    size?: 'small' | 'medium' | 'large';
    splash?: boolean;
  ...
  type NotificationProps = BoxProps<Notification> & {
    closer?: React.ReactNode | boolean;
  ...
  type QuoteProps = BoxProps<Quote> & {
  ...
  type SidebarProps = BoxProps<Sidebar> & {
    fixed?: boolean;
